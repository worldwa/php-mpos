...
<head>
  ...
  <!--[if IE 7]><link rel="stylesheet" href="css/fontello-ie7.css"><![endif]-->
	...
	<![endif]-->
	<script type="text/javascript" src="{$PATH}/jquery.min.js" type="text/javascript"></script>
	<script type="text/javascript" src="{$PATH}/jquery-migrate.min.js" type="text/javascript"></script>
