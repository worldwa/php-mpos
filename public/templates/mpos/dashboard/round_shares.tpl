         <tr>
           <td colspan="2"><b><u>周期贡献数</u></b> <span id='tt'><img src='{$PATH}/images/questionmark.png' height='15px' width='15px' title='Submitted shares since last found block (ie. round shares)'></span></td>
         </tr>
         <tr>
           <td><b>预估爆块需要贡献数</b></td>
