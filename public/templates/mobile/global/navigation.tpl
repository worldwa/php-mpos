        ...
        <div data-role="navbar">
          <ul>
            ...
            {else}
            <li><a href="{$smarty.server.PHP_SELF}" data-icon="info" data-ajax="false">新闻</a></li>
            <li><a href="{$smarty.server.PHP_SELF}?page=login" data-icon="gear" data-ajax="false">登录</a></li>
            {/if}
          </ul>
        </div>
