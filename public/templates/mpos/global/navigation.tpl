    ...
    <ul class="toggle">
      ...
      <li class="icon-exchange"><a href="{$smarty.server.PHP_SELF}?page=admin&action=transactions">交易</a></li>
      ...
      <li class="icon-photo"><a href="{$smarty.server.PHP_SELF}?page=admin&action=poolworkers">矿工</a></li>
    </ul>
    {/if}
